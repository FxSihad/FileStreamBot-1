...
<a href="https://heroku.com/deploy?template=https://github.com/dqanshi/FileStreamBote">
...
```py
git clone https://github.com/dqanshi/FileStreamBot
cd FileStreamBot
...
- [dangerbots](https://telegram.me/dangerbots)
